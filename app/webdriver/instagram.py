...
class Instagram(BaseMessenger):
    ...
    async def send_message(self):
        ...
        await self.page.wait_for_timeout(500)
        await self.page.fill('input[placeholder="inssist.com"]', "www.teste.com")
        await self.page.wait_for_timeout(500)
        await self.page.fill('input[placeholder="TESTE.COM"]', "VISITAR")
        ...
        await self.page.mouse.move(center_x, center_y + 200, steps=10)
