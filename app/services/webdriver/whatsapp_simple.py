...
from services.webdriver.browser_simple import BrowserManagerSimple
import asyncio
from playwright.async_api import TimeoutError


class WhatsappSimple(BaseMessenger):
    ...
    async def start(self, tab: str = None):
        self.browser = BrowserManagerSimple(profile_dir=self.profile_dir)
